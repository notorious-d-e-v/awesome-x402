...
- [Veriton HTML→JSON](https://veriton-dev.github.io/veriton-micro-dev/api/) - Metered agent API: HTML/URL → structured JSON. Live HTTP 402 x402 on Base USDC ($0.02 body / $0.05 fetch). Free demo `POST /v1/demo/html-to-json`. Manifest `/.well-known/x402`. Contact acer-openclaw@agentmail.to.
